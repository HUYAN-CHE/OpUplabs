...
const i18n = {
    zh: {
        ...
        metaExtensions: '个产品', metaCategories: '个分类', metaAvg: '次探索',
        thNo: '序号', thName: '名称', thCat: '分类', thRating: '状态', thUsers: '年份',
        emptyTitle: '未找到产品', emptyDesc: '尝试其他分类',
        footerLeft: 'UpLabs — 2026', footerRight: '持续实验',
        triggerLabel: '菜单',
    ...
    en: {
        ...
        heroLabel: 'Experiment. Fail. Discover.',
        heroTitle: 'Every failed experiment is a step toward what users truly need.',
        heroDesc: 'This is where abandoned prototypes rest — and where the truth about product-market fit is unearthed. We don\'t fear failure; we dig through it to find what works.',
        metaExtensions: 'Products', metaCategories: 'Categories', metaAvg: 'Experiments',
        ...
        footerLeft: 'UpLabs — 2026', footerRight: 'Continuous Experiment',
        triggerLabel: 'Menu',
